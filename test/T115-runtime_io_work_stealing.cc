/**
 * @file T115-runtime_io_work_stealing.cc
...
#else
#error "T115-RuntimeIOWorkStealing requires kqueue, epoll, or io_uring"
#endif
...
int main() {
    try {
        ...
        std::cerr << "[T115] unexpected exception: " << ex.what() << "\n";
        return 1;
    }

    std::cout << "T115-RuntimeIOWorkStealing PASS\n";
    return 0;
}
