/**
 * @file T124-io_uring_multishot_accept_runtime.cc
...
int main() {
#ifndef USE_IOURING
    LogInfo("T124-IOUringMultishotAcceptRuntime skipped: requires io_uring backend");
    return 0;
#else
    LogInfo("=== T124: io_uring multishot accept runtime regression ===");
