/**
 * @file T127-io_uring_multishot_recv_runtime.cc
...
int main() {
#ifndef USE_IOURING
    LogInfo("T127-IOUringMultishotRecvRuntime skipped: requires io_uring backend");
    return 0;
#else
    LogInfo("=== T127: io_uring multishot recv runtime regression ===");
